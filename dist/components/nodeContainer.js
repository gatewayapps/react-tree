...
var NodeContainer = exports.NodeContainer = function (_React$Component) {
  ...
  function NodeContainer() {
    ...
    return _possibleConstructorReturn(this, (NodeContainer.__proto__ || Object.getPrototypeOf(NodeContainer)).apply(this, arguments));
  }
  ...
  _createClass(NodeContainer, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: this.props.style, className: 'react-tree-node-container' },
        this.props.renderNodeToggle(),
        this.props.renderNodeTitle(),
        this.renderActions(),
    ...
    value: function renderActions() {
      if (this.props.node.actions !== undefined && this.props.node.actions instanceof Array) {
        ...
        for (var i = 0; i < this.props.node.actions.length; i++) {
          actions.push(this.props.renderNodeAction(this.props.node));
        }
        return _react2.default.createElement(
          'div',
          { className: 'react-tree-node-container-actions' },
          actions
        );
      }
    }
